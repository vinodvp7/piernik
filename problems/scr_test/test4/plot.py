...
plt.plot(x,y_analytical(0.2,x),label='t=0.2 (Analytical)',linewidth=2.0,color='b', linestyle='dashed')
...
plt.plot(x,y_analytical(0.4,x),label='t=0.4 (Analytical)',linewidth=2.0,color='cyan', linestyle='dashed')
