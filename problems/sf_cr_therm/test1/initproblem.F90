...
! Modified by M.Hanasz for CR-driven dynamo
   ...
   real :: x0, y0, z0, tlim, h0, g_a, T_mid                                  !< parameters for a single supernova exploding at t=0
   real, dimension(ndims) :: b_n, sn_pos
   logical :: fixedsn

   namelist /PROBLEM_CONTROL/  d0, bxn, byn, bzn, x0, y0, z0, alpha, amp_cr, beta_cr, fixedsn, tlim, h0, g_a, T_mid
...
!-----------------------------------------------------------------------------
   ...
   subroutine problem_initial_conditions
      ...
      use hydrostatic,    only: thermal_hydro_zeq_Tmid, set_default_hsparams, dprof
#ifdef SHEAR
