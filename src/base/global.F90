...
module global
   ...
   character(len=cbuff_len)      :: solver_type       !< allow to switch between SPLIT and UNSPLIT without recompilation
...
!<
   subroutine init_global
      ...
      use constants,  only: big_float, one, PIERNIK_INIT_DOMAIN, INVALID, DIVB_CT, DIVB_HDC, &
           ...
           &                RTVD_SPLIT, HLLC_SPLIT, RIEMANN, SPLIT, UNSPLIT, GEO_XYZ, V_INFO, V_DEBUG, V_ESSENTIAL
