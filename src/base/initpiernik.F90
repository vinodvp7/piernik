...
!<
   ...
   subroutine init_piernik
      ...
      !! BEWARE: Fc has to be scaled in initial condition. Do we need to scale Fc after reading from restart ?
...
! #ifdef STREAM_CR
!          call scr_initial_tasks               ! Need to scale Fc by vm : Fc-> Fc/vm   . is this call needed here ?
! #endif /* STREAM_CR */
            call ppp_main%stop(prob_label)
