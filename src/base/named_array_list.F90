...
module named_array_list
   ...
   type, extends(na_var_list) :: na_var_list_w
      ...
      integer(kind=4) :: xflx   = INVALID                            !< X face-flux field of fluid                : cg%w(wna%xflx)      
      integer(kind=4) :: yflx   = INVALID                            !< Y face-flux field of fluid                : cg%w(wna%yflx)   
      integer(kind=4) :: zflx   = INVALID                            !< Z face-flux field of fluid                : cg%w(wna%zflx)
      ...
      integer(kind=4) :: psiflx = INVALID                            !< flux of the scalar field psi              : cg%w(wna%psiflx)  
