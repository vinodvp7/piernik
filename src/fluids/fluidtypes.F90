...
!<
   ...
   subroutine set_scr_index(this,flind)
      use diagnostics, only: ma1d, ma2d, my_allocate
      ...
      ! Suppose that ionized fluid is already initialized. So that flind%all = 5 cuurently
      ! Also flind%stcosm = 0 at this point. flind%components = 1 because of the 1 ionized component
      ...
      iscr = iscr + I_ONE
      flind%stcosm     = flind%stcosm + I_ONE          ! # of streaming cosmic rays. This should be 2 after both nscr is updated
