...
! pulled by STREAM_CR
   ...
   integer                                 :: Nsub, sub_count
   real                                    :: dt_scr
   logical                                 :: substepping = .false.      !< whether to add cr sound speed when calculating v_diff. Ideally keep it as false so that sound speed is added as it increases numerical stability.   
contains
