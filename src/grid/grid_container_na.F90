...
module grid_cont_na
   ...
   type, extends(grid_container_base_t), abstract :: grid_container_na_t
      ...
      real, dimension(:,:,:,:), pointer :: bfx     => null()  !< Main array of X-faced flux field components of magnetic field
      real, dimension(:,:,:,:), pointer :: bgy     => null()  !< Main array of Y-faced flux field components of magnetic field
      real, dimension(:,:,:,:), pointer :: bhz     => null()  !< Main array of Z-faced flux field components of magnetic field
      real, dimension(:,:,:,:), pointer :: psiflx  => null()  !< Main array of all fluxes in different directions for the scalar field psi
   contains
